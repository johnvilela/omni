...
- No ai-memory Go dependency — Omni talks to the single local ai-memory service with stdlib HTTP/JSON-RPC. The installer owns the service setup and its low-resource systemd limits.
